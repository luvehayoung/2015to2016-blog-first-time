...
$('.slider').each(function() {              // 모든 슬라이더를 찾는다
  ...
  function advance() {                     // 타이머를 설정한다
    ...
    }, 7000);                              // 대기할 시간을 밀리 초로 지정한다
 */
    /*수정한부분*/
    
    $(".about_design").on("mousewheel",function(e){
  ...
  $.each($slides, function(index) {
	// button 요소를 생성한다
    var arr=["concept","metaphor","logo","color"];
    var $button = $('<button type="button" class="slide-btn">'+arr[index]+'</button>');
